...
LOAD_SPECS = (
    ...
    TableLoadSpec(
        ...
        conflict_columns=("calculation_id",),
    ),
    TableLoadSpec(
        dataset_key="daily_volatility",
        table_name="daily_volatility",
        columns=(
            "calculation_id",
            "model_version",
            "source",
    ...
    TableLoadSpec(
        dataset_key="daily_risk_summary",
        table_name="daily_risk_summary",
        columns=(
            "calculation_id",
            "model_version",
            "source",
    ...
    TableLoadSpec(
        dataset_key="portfolio_daily_returns",
        table_name="portfolio_daily_returns",
        columns=(
            "calculation_id",
            "model_version",
            "portfolio_id",
    ...
    TableLoadSpec(
        dataset_key="portfolio_daily_risk_summary",
        table_name="portfolio_daily_risk_summary",
        columns=(
            "calculation_id",
            "model_version",
            "portfolio_id",
